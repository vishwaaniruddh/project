...
$formData = [
    ...
    'unit_of_measure' => '',
    'default_quantity' => '',
    'status' => SarInvMaterialMaster::STATUS_ACTIVE
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $result = $materialService->createMaterialMaster($formData);
        
        if ($result['success']) {
            $_SESSION['success'] = 'Material master created successfully';
            header('Location: ' . url('/admin/sar-inventory/materials/view.php?id=' . $result['material_id']));
            exit;
        } else {
...
<div class="mb-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Material Master</h1>
            <p class="text-gray-600">Define a new material template with specifications</p>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t">
                <a href="<?php echo url('/admin/sar-inventory/materials/'); ?>" class="btn btn-secondary">Cancel</a>
